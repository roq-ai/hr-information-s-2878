...
function CompanyViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<CompanyInterface>(
    ...
    () =>
      getCompanyById(id, {
        relations: ['user', 'customer_request', 'employee'],
      }),
  );
                      ...
                      <Tbody>
                        {data?.employee?.map((record) => (
                          <Tr
                            ...
                            key={record.id}
                          >
                            <Td>{record.employment_start_date as unknown as string}</Td>
                            <Td>{record.employment_end_date as unknown as string}</Td>
